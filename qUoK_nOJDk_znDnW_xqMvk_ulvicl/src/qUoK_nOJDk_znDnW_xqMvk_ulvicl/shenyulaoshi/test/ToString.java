...
public class ToString {
	...
	public static void printlnArray(int[] objs) {
		StringBuffer sb = new StringBuffer();
		sb.append("[");
		sb.append(Thread.currentThread().getStackTrace()[2].getClassName());
		sb.append(" ");
	...
	public static void printlnClass(Object... obj) {
		StringBuffer sb = new StringBuffer();
		sb.append("[");
		sb.append(Thread.currentThread().getStackTrace()[2].getClassName());
		sb.append(" ");
...
//		ToString.makeEnumSwitch(WinType.values());
//		ToString.makeEnumSwitchInt2Type(WinType.values());
	}
}
